...
print("Sorting Data According to Total Cases :")
data = aggregated_data.sort_values(by=["Total Cases"], ascending=False)
print(data.head())

# Top 10 Countries with Highest Covid Cases
data = data.head(10)
print("Top 10 Contries with Highest Covid Cases : ")
print(data)
...
print("compare the total number of cases and total deaths in all these countries")
...
#Analysis of Covid Impact on Economy
